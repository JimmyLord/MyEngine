...
namespace MyEngine
{ 
    public class GameObject : MyNativeObject
    {
        public ComponentTransform GetTransform() { return GameObject.GetTransform( NativeObject ); }
        public ComponentBase GetFirstComponentOfType(string type) { return GameObject.GetFirstComponentOfType( NativeObject, type ); }
        public ComponentBase AddNewComponent(string type) { return GameObject.AddNewComponent( NativeObject, type ); }
