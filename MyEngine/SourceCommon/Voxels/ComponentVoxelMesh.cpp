...
void ComponentVoxelMesh::RegisterVariables(TCPPListHead<ComponentVariable*>* pList, ComponentVoxelMesh* pThis) //_VARIABLE_LIST
{
...
#if MYFW_USING_WX
    AddVar( pList, "TextureTileCount", ComponentVariableType::Vector2Int, MyOffsetOf( pThis, &pThis->m_TextureTileCount ), false, true, 0, (CVarFunc_ValueChanged)&ComponentVoxelMesh::OnValueChanged, (CVarFunc_DropTarget)&ComponentVoxelMesh::OnDrop, 0 );
    AddVar( pList, "MaxSize", ComponentVariableType::Vector3Int, MyOffsetOf( pThis, &pThis->m_ChunkSize ), false, true, 0, (CVarFunc_ValueChanged)&ComponentVoxelMesh::OnValueChanged, (CVarFunc_DropTarget)&ComponentVoxelMesh::OnDrop, 0 );
    AddVar( pList, "BlockSize", ComponentVariableType::Vector3, MyOffsetOf( pThis, &pThis->m_BlockSize ), false, true, 0, (CVarFunc_ValueChanged)&ComponentVoxelMesh::OnValueChanged, (CVarFunc_DropTarget)&ComponentVoxelMesh::OnDrop, 0 );
    ...
    AddVarPointer( pList, "File", true, true, "File",
        ...
        (CVarFunc_DropTarget)&ComponentVoxelMesh::OnDrop, 0 );
#else
    AddVar( pList, "TextureTileCount", ComponentVariableType::Vector2Int, MyOffsetOf( pThis, &pThis->m_TextureTileCount ), false, true, 0, (CVarFunc_ValueChanged)&ComponentVoxelMesh::OnValueChanged, 0, 0 );
    AddVar( pList, "MaxSize", ComponentVariableType::Vector3Int, MyOffsetOf( pThis, &pThis->m_ChunkSize ), false, true, 0, (CVarFunc_ValueChanged)&ComponentVoxelMesh::OnValueChanged, 0, 0 );
    AddVar( pList, "BlockSize", ComponentVariableType::Vector3, MyOffsetOf( pThis, &pThis->m_BlockSize ), false, true, 0, (CVarFunc_ValueChanged)&ComponentVoxelMesh::OnValueChanged, 0, 0 );
