...
public:
    ...
    static void StaticOnValueChanged(void* pObjectPtr, int controlid, bool finishedchanging, double oldvalue) { ((ComponentCameraShadow*)pObjectPtr)->OnValueChanged( controlid, finishedchanging ); }
