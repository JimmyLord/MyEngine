...
: wxDialog( parent, id, title, position, size, style)
{
    ...
    pos.x += 10;
    sprintf_s( tempstr, 20, "%0.02f", g_pEngineCore->GetEditorPrefs()->GetGridSettings()->stepsize.x );
    m_GridStepX = new wxTextCtrl( this, -1, tempstr, wxPoint( pos.x, pos.y - 3 ), wxSize(40, 20) );
    pos.x += 50;

    new wxStaticText( this, -1, "Y", pos );
    pos.x += 10;
    sprintf_s( tempstr, 20, "%0.02f", g_pEngineCore->GetEditorPrefs()->GetGridSettings()->stepsize.y );
    m_GridStepY = new wxTextCtrl( this, -1, tempstr, wxPoint( pos.x, pos.y - 3 ), wxSize(40, 20) );
    pos.x += 50;

    new wxStaticText( this, -1, "Z", pos );
    pos.x += 10;
    sprintf_s( tempstr, 20, "%0.02f", g_pEngineCore->GetEditorPrefs()->GetGridSettings()->stepsize.z );
...
void DialogGridSettings::OnOk(wxCommandEvent& event)
{
    ...
    g_pEngineCore->GetEditorPrefs()->GetGridSettings()->stepsize.Set( x, y, z );
